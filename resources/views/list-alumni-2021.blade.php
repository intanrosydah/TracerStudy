...
@section('title')
<h2 class="h4 mb-4 text-light">Data Alumni Tahun 2021</h2>
@endsection
    ...
    <div class="col">
        <div class="card o-hidden border-0 shadow-lg">
            <div class="card-header">
               List Data Alumni Tahun 2021
            </div>
            <div class="card-body">
                <table class="table table-hover" id="tableListAlumni2021">
                    <thead>
                      <tr>
...
@push('js')
    <script>
        var routeDataAlumni2021 = '<?php echo route('dataAlumni2021') ?>';
    </script>

    <script src="{{ asset('js/list-alumni2021.js') }}"></script>
@endpush
