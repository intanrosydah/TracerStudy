...
class ListAlumniController extends Controller
{
    ...
    public function ListDataAlumni2020(Request $request)
    {
        $tahunAngkatan = AlumniAngkatan::where('tahun_angkatan', '2020')
            ->first()
            ->id;
    ...
    public function ListDataAlumni2021(Request $request)
    {
        $tahunAngkatan = AlumniAngkatan::where('tahun_angkatan', '2021')
            ->first()
            ->id;
